...
The goal of this section is to describe the data used in the Temperature Fluctuation paper and how these data are organized. All the data are available in the fgnTemp repository, and their organization strongly depend from the aim of the analysis that we have carried out.
