...
date: '2020-04-17'
slug: paper-results
summary: This section contains all the results included in the Temperature paper, along with the code that generated them
categories: 
  - research
tags: 
  - research
...
```{r F1. Printing, echo = F}
include_graphics("/img/temperature/F1.Self-similarity yearly monthly data.png")
```
...
```{r F2. Printing page 1, echo = F, fig.height=4}
include_graphics("/img/temperature/F2_SelfSim_Norm_test_1.pdf")
```

```{r F2. Printing page 2, echo = F}
include_graphics("/img/temperature/F2_SelfSim_Norm_test_1.pdf")
```


```{r F2. Printing page 3, echo = F}
include_graphics("/img/temperature/F2_SelfSim_Norm_test_1.pdf")
```
...
```{r F3.1, echo = F}
include_graphics("/img/temperature/F3_simulations_H_0.7.pdf")
```

```{r F3.2, echo = F}
include_graphics("/img/temperature/F3_simulations_H_0.8.pdf")
```

```{r F3.3, echo = F}
include_graphics("/img/temperature/F3_simulations_H_0.9.pdf")
```
...
```{r F5b, echo = F}
include_graphics("/img/temperature/F5b_moberg_Ntest.pdf")
```
...
```{r F6, out.width = "80%", echo = F}
include_graphics("/img/temperature/F6_Moberg_autocorrelation.png")
```