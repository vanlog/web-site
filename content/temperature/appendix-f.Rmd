...
date: '2020-04-23'
slug: appendix-f
summary: Details on the selection procedure of the available temperature time series 
categories: 
  - research
tags: 
  - research
...
All the data are available in the tempFgn repository, see the [temperature data section](temperature/temperature-data) for more.   
...
```{r T02_Information2 building, eval = F}
...
T02_Information2 <- read.csv("./tbl/T02_Information2.csv") %>%
  select(-Stationame)
...
```{r cita data , fig.width=6, fig.height=4, fig.align="center", eval =F}
...
```{r vilnius data, fig.width=6, fig.height=4, fig.align="center", eval =F }
...
Summary statistics of the selected of 96 time series is shown in [Appendix B](/temperature/appendix-b), table B1. 
